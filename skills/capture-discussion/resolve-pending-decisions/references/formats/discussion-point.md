...
A discussion point is a compact, self-contained structure that gives the reader everything needed to settle a single choice, and nothing that belongs to a broader conversation. It is transient framing — the options menu, recommendation, and deliberation needed to reach a choice — with no lasting value once the choice is made; producing the settled decision's durable record is a separate step.
