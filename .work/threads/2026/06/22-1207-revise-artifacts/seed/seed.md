...
`.wip/threads/2026/06/22-1024-workflow-dx-orchestration/` (lightening how the spine
...
`.wip/threads/2026/06/12-1740-agentic-workflow-v2/` implementation report — the
