...
- Two-step picker UX: searchable list grouped by workflow module (with deprecated skills sectioned at the bottom and a Markdown preview panel), followed by a form to attach the prompt.
