...
A roadmap index holds one direction: where it is going and the entries that get there. It is a project-level file at `.work/roadmaps/<yymmddhhmm>-<slug>.md`, where the stamp is the index's creation time in UTC at minute resolution.
