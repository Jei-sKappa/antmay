...
1. Present the next unresolved point in chat, framed per the format in `references/formats/discussion-point.md`, then let the user settle it. Take one point per turn; do not batch.
