...
1. **Coherence** — does the plan, executed end-to-end, actually achieve the primary input's goal? Does completing every plan task satisfy the spec's intended goal and acceptance guidance, or, where a referenced artifact is the form, elaborate what it asks for into a complete implementable sequence?
