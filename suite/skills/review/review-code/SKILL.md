...
- The thread's `spec.md`, when present — the thread's design truth; its acceptance criteria define what the code is meant to do, which is what an intent-dependent finding rests on.
